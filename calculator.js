/**
 * CashCalc.in — Indian Cash Denomination Calculator
...
(function () {
  ...
  function shareSummary() {
    ...
    if (navigator.share) {
      navigator.share({
        title: 'Cash Denomination Summary — CashCalc',
        text: text,
...
<head>
  <meta charset="UTF-8">
  <title>Denomination Sheet — CashCalc</title>
  <style>
...
<body>
  ...
  <p class="subtitle">Generated on ${date} at ${time} | CashCalc.in</p>
  <table>
    <thead>
      <tr>
  ...
  <div class="footer">
    <p>Generated by CashCalc — Indian Cash Denomination Calculator</p>
  ...
  function buildSummaryText() {
    ...
    lines.push('\nGenerated by CashCalc — cashdenominationcalculator.github.io');
